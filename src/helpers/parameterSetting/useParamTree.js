    ...
    applyParamTree(tree) {
      ...
      const cloneNode = (node) => {
        ...
        return {
          ...
          unit: node.unit ?? null,
          convertedValue: node.convertedValue ?? null,
          primaryValue: node.primaryValue ?? null,
          convertedMinVal: node.convertedMinVal ?? null,
          convertedMaxVal: node.convertedMaxVal ?? null,
          convertedUnit: node.convertedUnit ?? null,

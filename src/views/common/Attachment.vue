  ...
  <div>
    ...
    <span class="bolder"
      ...
      <span class="last-right-parent">
        <i
          @click="downloadItem(rowCurrent)"
          class="fa fa-download mgr-10 pointer"
        ></i>
        <i
          @click="openFile()"
          class="fa-solid fa-folder-open mgr-10 pointer"
        ></i>
        ...
        <i
          @click="deleteItem(rowCurrent)"
          class="fa-solid fa-trash mgr-10 pointer"
        ></i>
      </span>
    </span>
    ...
    async launchFile() {
      if (this.fileURL[this.rowCurrent] != -1) {
        ...
        try {
          ...
          let dataFile = await fileAPI.download(
            this.rowData[this.rowCurrent].name,
            this.dataParent.name,
            this.dataParent.id
          );
